...
class UNET_EFFICIENTNET(torch.nn.Module):
    def __init__(self):
        ...
        self.final1 = torch.nn.Conv2d(2112, 128, kernel_size=1)
        self.final2 = torch.nn.Conv2d(128, 128, kernel_size=1)
    ...
    def forwardhead(self, z,h=512,w=512):
