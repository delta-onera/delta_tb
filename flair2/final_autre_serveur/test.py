...
print("load model")
net = DeepEnsemble(
    "/d/achanhon/FLAIR_2/MODELS/eff1.pth",
    "/d/achanhon/FLAIR_2/MODELS/eff2.pth",
    "/d/achanhon/FLAIR_2/MODELS/vit1.pth",
    "/d/achanhon/FLAIR_2/MODELS/vit2.pth",
    "/d/achanhon/FLAIR_2/MODELS/conv1.pth",
    "/d/achanhon/FLAIR_2/MODELS/conv2.pth",
)
net = net.cuda()
net.eval()
net.half()
...
with torch.no_grad():
    for iiii in range(N):
        ...
        writter.asynchronePush(
            "/d/achanhon/Desktop/PREDFLAIR2/PRED_" + number6(name) + ".tif", z
        )
