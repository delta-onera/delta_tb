...
class DeepEnsemble(torch.nn.Module):
    ...
    def forward(self, x, s):
        ...
        pp1 = torch.nn.functional.leaky_relu(p1)
        pp2 = torch.nn.functional.leaky_relu(p2)
        pp3 = torch.nn.functional.leaky_relu(p3)
        pp4 = torch.nn.functional.leaky_relu(p4)
        pp5 = torch.nn.functional.leaky_relu(p5)
        pp6 = torch.nn.functional.leaky_relu(p6)
