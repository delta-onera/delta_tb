...
class PhysicalData():
    def __init__(self, names=None, flag="minmax"):
		...
		print("calibrate normalization")
		for i in range(self.NB[name]):
				
				
			


	def minmax(self,image, imin, imax):
	...
	def onlineminmax(self, image, removeborder=True):
        ...
        if imin == imax:
			...
			return self.minmax(image,imin, imax)
