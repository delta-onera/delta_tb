...
do
    /home/jcastillo/anaconda3/bin/python -u minifrance_train.py $town | tee build/vaihingen_train_$town.txt
    /home/jcastillo/anaconda3/bin/python -u minifrance_test.py $town | tee build/vaihingen_test_$town.txt
done
