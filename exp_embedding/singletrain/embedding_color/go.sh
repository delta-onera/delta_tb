...
/data/anaconda3/bin/python -u test.py  POTSDAM | tee ../results/avbp2p_color_sum.txt

/data/anaconda3/bin/python -u train.py AIRS VAIHINGEN BRUGES POTSDAM
/data/anaconda3/bin/python -u test.py  POTSDAM | tee ../results/avbp2p_color_graph.txt
